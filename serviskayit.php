...
if($_POST) {
	...
	$html = '<b>Ad Soyad:</b> '.$_POST['adsoyad'].'<br /><b>Telefon:</b> '.$_POST['telefon'].'<br /><b>Şikayet:</b> '.$_POST['sikayet'].'<br /><b>Garanti Durumu:</b> '.$_POST['garanti'].'<br><b>Cihaz Türü:</b>' .$_POST['cihaz'].'<br /><b>Adres:</b> '.$_POST['adres'].'<br /><b>Kaynak:</b> '.$url;
